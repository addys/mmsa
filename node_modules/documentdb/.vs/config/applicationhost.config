...
<configuration>
    ...
    <system.applicationHost>
        ...
        <sites>
            ...
            <site name="DocumentDB" id="2">
                <application path="/" applicationPool="Clr4IntegratedAppPool">
                    <virtualDirectory path="/" physicalPath="E:\GitHub\ryancrawcour\azure-documentdb-node\source" />
                </application>
                <bindings>
                    <binding protocol="http" bindingInformation="*:39938:localhost" />
                </bindings>
            </site>
            <siteDefaults>
